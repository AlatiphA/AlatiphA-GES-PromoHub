...
/* Mobile — single touchstart/touchend pair
   handles BOTH swipe-left AND tap-outside */
...
document.addEventListener("touchend", e => {
  ...
  if (_swipeX !== null) {
    ...
    /* Short tap outside sidebar → close */
    if (
      Math.abs(dx) < 10 &&
      Math.abs(dy) < 10 &&
      el &&
